...
team_t team = {
    ...
    "Anbu Chelvan Francis",     /* First member full name */
    "anbu.vimalan.1@iliauni.edu.ge",  /* First member email address */

    "Vikas Parmar",                   /* Second member full name (leave blank if none) */
    "vikas.parmar.1@iliauni.edu.ge"                    /* Second member email addr (leave blank if none) */
};
